To use, make sure [Node.js](http://nodejs.org) and [Mocha](http://mochajs.org/) are installed and added to the PATH environment variable. These can be obtained from:
